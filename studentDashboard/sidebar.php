...
<body>
    <div class="container-fluid flex-column sticky-top p-0">
        ...
        <div class="bg-dark col-auto  min-vh-100 flex-wrap">
            ...
            <div class="p-1 h-75">
                ...
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                        <a href="./stud_welcome.php" class="nav-link text-white fs-5 p-1 px-3 my-1">
                            <i class="fs-5 fa fa-house me-3"></i>Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="./mentees_query.php" class="nav-link text-white fs-5 p-1 px-3 my-1">
                            <i class="fa-solid fa-comment me-3"></i>Query
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="p-1">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                        <a href="./stud_profile.php" class="nav-link text-white fs-5 p-1 px-3 my-1">
    ...
    <script>
        $(document).ready(function() {
            ...
            let storedThemeMode = localStorage.getItem("menteeThemeMode");
            if (storedThemeMode) {
            ...
            $("#toggle-theme-mode").on("click", function(e) {
                ...
                let currentThemeMode = localStorage.getItem("menteeThemeMode") || "light";
